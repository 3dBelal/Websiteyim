...
$(function() {
    ...
    // Use imagesLoaded to check for images
    $container.imagesLoaded({ background: true }, function() {
        ...
        if (totalVideos === 0) {
            // No videos, proceed to show content
            showContent();
        } else {
            $videos.each(function() {
                $(this).on('loadeddata', function() {
                    ...
                    if (videosLoaded === totalVideos) {
                        // All videos loaded, proceed to show content
                        showContent();
                    }
                });
    ...
    function showContent() {
        ...
        // Initialize animations (AOS already initialized at top)
        // Add other initialization code here if needed
    }

    // Fallback: Force show content after 10 seconds
    setTimeout(showContent, 10000);

    // Original custom.js functions
